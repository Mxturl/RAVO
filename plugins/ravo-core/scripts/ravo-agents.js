...
- For long-running Goal-mode prompt requests, first check for a decision-complete spec. If none exists, do not write any runnable Goal prompt; offer to generate the spec first.
