...
const context = [
  ...
  "Before accepted or release_ready, check the RAVO security baseline: data/privacy, credentials, permissions, destructive actions, external calls, dependencies, logs/artifacts, and global knowledge sharing.",
